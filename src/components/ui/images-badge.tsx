...
export function ImagesBadge({
  ...
  return (
    <Component
      ...
      className={cn(
        "inline-flex cursor-pointer items-center gap-2 [perspective:1000px] [transform-style:preserve-3d]",
        className
      )}
      ...
      >
        ...
        {displayImages.map((image, index) => {
          ...
          return (
            <motion.div
              key={index}
              className="absolute left-1/2 top-0.5 origin-bottom overflow-hidden rounded-[3px] bg-white shadow-sm ring-1 shadow-black/10 ring-black/10 dark:bg-neutral-800 dark:shadow-white/10 dark:ring-white/10"
              animate={{
